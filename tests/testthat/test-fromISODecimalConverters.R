...
df <- data.frame(decimal = c('999012345678901','999012345678902','999012345678903','999012345678904','999012345678905','999012345678906','999012345678907','999012345678908','999012345678909','999012345678910'),
...
test_that("Decimal to Dot Hex Works",{
  expect_equal(ISOdecimalToISOdothex(df$decimal), df$isodothex)
})

test_that("Decimal to 64 Bit Left Works",{
  expect_equal(ISODecimalToISO64bitLeft(df$decimal), df$iso64bitleft)
})

test_that("Decimal to 64 Bit Right Works",{
  expect_equal(ISODecimalToISO64bitRight(df$decimal), df$iso64bitright)
})
