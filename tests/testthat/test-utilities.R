...
df <- data.frame(isodecimal = c(NA,'999012345678901','999012345678902','999012345678903',NA,'999012345678904','999012345678905','999012345678906','999012345678907','999012345678908','999012345678909','999012345678910',NA),
                 ...
                 isodecimal_extra = c('989.0010399414','999.012345678901','999_012345678902','999_012345678903','989.0010399415','999.012345678904','999.012345678905','999_012345678906','999_012345678907','999.012345678908','999.012345678909','999_012345678910',NA),
                 stringsAsFactors = F)
...
test_that("get_iso11784_format Works",{
  suppressWarnings({
    expect_equal(
      get_iso11784_format(
        c(df$isodecimal[1:2],df$isodothex[1:2],df$iso64bitleft[1:2],df$iso64bitright[1:2],df$isodecimal_extra[2:3],c('1234567890123','ABD.4567890123'))
      ),
      c('unknown','isodecimal','unknown','isodothex','unknown','iso64bitl','unknown','iso64bitr','isodecimal','isodecimal','unknown','unknown')
    )
  })
})
...
test_that("Convert to ISO Decimal Works",{
  suppressWarnings({
    ...
    expect_equal(convert_to_isodecimal(df$isodecimal_extra), df$isodecimal)
  })
})
...
test_that("Convert to ISO Dot Hexadecimal Works",{
  ...
  expect_equal(convert_to_isodothex(df$isodecimal_extra), df$isodothex)
  })
})
...
test_that("Convert to ISO Raw Hexadecimal (Animal bit left) Works",{
  ...
  expect_equal(convert_to_iso64bitl(df$isodecimal_extra), df$iso64bitleft)
  })
})
...
test_that("Convert to ISO Raw Hexadecimal (Animal bit right) Works",{
  ...
  expect_equal(convert_to_iso64bitr(df$isodecimal_extra), df$iso64bitright)
  })
})
