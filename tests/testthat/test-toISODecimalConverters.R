...
test_that("Dot Hex to Decimal Works",{
  expect_equal(ISOdothexToISOdecimal(df$isodothex), df$decimal)
})

test_that("64 Bit Left to Decimal Works",{
  expect_equal(ISO64bitLeftToISODecimal(df$iso64bitleft), df$decimal)
})

test_that("64 Bit Right to Decimal Works",{
  expect_equal(ISO64bitRightToISODecimal(df$iso64bitright), df$decimal)
})
